 ...
 */
public class ProcessExcelCatalouge {

    public static void main(String[] args)
    {
        if (args.length > 4 || args.length < 4)
        {
            System.out.println(" incorrect arguments: please provide the following A) file "
                    + "to pick list of images  B) File with text catalouge C) File for Photo Cataloge "
                    + "and D)location to save files to ");
            System.exit(0);
        }
        else
        {
